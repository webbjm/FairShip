...
class sndHit : public TObject
{
  ...
  public:
    ...
    sndHit(Int_t detID,Int_t nSiPMs=1,Int_t nSides=0);
...
// to be implemented by the subdetector
    ...
    /*** Get energy */
    // virtual Float_t GetEnergy();  // causes problems, don't know why: cling::DynamicLibraryManager::loadLibrary(): lib/libShipData.so.0.0.0: undefined symbol: _ZN9sndHit9GetEnergyEv
