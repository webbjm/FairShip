...
enum DetectorId {kVETO, kTimeDet, ktauRpc, ktauHpt, ktauTT, ktauTarget, kAdvSNDTarget, kStraw, kecal, khcal, kMuon , kPreshower, kTRSTATION, kSplitCal, kBox1, kSpectrometer, kPixelModules, kSciFi, kScintillator, kMufluxSpectrometer, kMuonTagger, kUpstreamTagger, kEndOfList};
